...
QOSDNotification::QOSDNotification(QWidget *parent):
    QAbstractOSDNotification(*new QOSDNotificationPrivate, parent, Qt::Widget)
{
...
void  QOSDNotification::enterEvent(QEnterEvent *event)
{
    Q_D(QOSDNotification);
...
void  QOSDNotificationPrivate::init()
{
    ...
    titleLabel->setWordWrap(true);
    {
        ...
        titleLabel->setStyleSheet("background-color: rgba(255, 255, 255, 0);");
    }
    ...
    bodyTextLabel->setWordWrap(true);
    {
        ...
        bodyTextLabel->setStyleSheet("background-color: rgba(0, 0, 0, 0);");
    }
...
void  QOSDNotificationPrivate::setPixmap(const QPixmap &pixmap, bool autoScale)
{
    ...
    pixmapLabel->setPixmap(!nullPixmap
                           && autoScale ? pixmap.scaled(qMin(pixmap.width(), 48), qMin(
                                                                                                                pixmap.height(), 48), Qt::KeepAspectRatio, Qt::SmoothTransformation) : pixmap);
}
